...
class SourceLibNoiseCore2 {
  ...
  static double gradientNoise3D(
    ...
    final xvGradient = _randomVectors[tableIndex];
    final yvGradient = _randomVectors[tableIndex + 1];
    final zvGradient = _randomVectors[tableIndex + 2];
  ...
  // Exact public-domain libnoise v1.0.0 `g_randomVectors[256 * 4]` table.
  static const List<double> _randomVectors = [
