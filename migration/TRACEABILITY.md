...
- code: `9f04863ea904552d8edd7034067630bd82f8be98`;
- workflow: `.github/workflows/flutter-parity.yml` run `35284252825` (#639), job `105412942943`;
- Flutter `3.47.2`, Dart `3.13.2`;
- analyzer: **No issues found**;
- tests: **874/874 passed**;
- conclusion: **success**.
