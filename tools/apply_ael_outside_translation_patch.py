...
helper = '''  static List<SourcePoint2>? _roundedAelOutsideTranslatedResultOrNull(
...
if old_tests not in t:
    raise SystemExit('fallback tests not found')
